...
- (void)_setDelegateInternal:(id)arg1;
...
- (void)_didReset;
- (void)_didFailToLoadFinalImageWithError:(id)arg1;
- (void)_didLoadFinalImageFromSource:(long long)arg1;
- (void)_didUpdateDisplayedImageContainer:(id)arg1 sourceDimensions:(struct CGSize)arg2 isFinal:(_Bool)arg3;
- (void)_didUpdateProgress:(float)arg1;
- (void)_didStartLoading;
- (_Bool)_shouldReloadAfterDifferentFetchCompletedWithImageContainer:(id)arg1 dimensions:(struct CGSize)arg2 identifier:(id)arg3 imageURL:(id)arg4 treatedAsPlaceholder:(_Bool)arg5 manuallyStored:(_Bool)arg6;
- (_Bool)_shouldLoadProgressivelyWithIdentifier:(id)arg1 imageURL:(id)arg2 imageType:(id)arg3 originalDimensions:(struct CGSize)arg4;
- (_Bool)_shouldContinueLoadingWithResult:(id)arg1;
- (_Bool)_shouldUpdateImageWithResult:(id)arg1;
...
- (id)_buildDebugInfoString:(out long long *)arg1;
- (void)_hideDebugInfo;
- (void)_showDebugInfo;
- (void)_tip_didUpdateDebugVisibility;
- (void)_tip_imageDidUpdate:(id)arg1;
- (void)_startObservingImagePipeline:(id)arg1;
- (id)_createRequestWithURL:(id)arg1;
- (id)_extractRequestFromDataSource:(id)arg1;
- (void)_refetchWithPeek:(id)arg1;
- (void)_cancelFetch;
- (void)_resetToImageContainer:(id)arg1;
- (void)_updateImageContainer:(id)arg1 sourceDimensions:(struct CGSize)arg2 URL:(id)arg3 source:(long long)arg4 type:(id)arg5 progress:(float)arg6 error:(id)arg7 metrics:(id)arg8 final:(_Bool)arg9 scaled:(_Bool)arg10 progressive:(_Bool)arg11 preview:(_Bool)arg12 placeholder:(_Bool)arg13;
- (_Bool)_resizeRequestIfNeeded;
