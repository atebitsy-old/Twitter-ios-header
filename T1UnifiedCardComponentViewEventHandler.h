...
+ (id)scribeContextWithUCDetailsForComponentEvent:(id)arg1 scribeContext:(id)arg2 sourceObject:(id)arg3;
...
- (id)handleEvent:(id)arg1 presentingViewController:(id)arg2 scribeContext:(id)arg3 promotedContent:(id)arg4 sourceObject:(id)arg5 account:(id)arg6;
