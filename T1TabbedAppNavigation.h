...
- (void)showList:(id)arg1 forUsername:(id)arg2 onPage:(unsigned long long)arg3 source:(long long)arg4 sourceNavigationMetadata:(id)arg5 completion:(CDUnknownBlockType)arg6;
