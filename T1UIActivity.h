...
@interface T1UIActivity : UIActivity
{
    ...
    NSString *_title;
    UIImage *_image;
    id <T1UIActivityDelegate> _delegate;
}

+ (long long)activityCategory;
- (void).cxx_destruct;
@property(nonatomic) __weak id <T1UIActivityDelegate> delegate; // @synthesize delegate=_delegate;
