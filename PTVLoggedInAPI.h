...
+ (void)EjectGuestBroadcastStreamForGuestCallerSession:(id)arg1 ChatToken:(id)arg2 NTPForCurrentFrame:(unsigned long long)arg3 NTPForBroadcasterFrame:(unsigned long long)arg4 LoggedInUser:(id)arg5 CompletionBlock:(CDUnknownBlockType)arg6;
+ (void)EndGuestBroadcastStreamForGuestCallerSession:(id)arg1 ChatToken:(id)arg2 NTPForCurrentFrame:(unsigned long long)arg3 NTPForBroadcasterFrame:(unsigned long long)arg4 LoggedInUser:(id)arg5 GuestAnalyticsManager:(id)arg6 CompletionBlock:(CDUnknownBlockType)arg7;
+ (void)CompleteCountdownForPublishingGuestCallerSession:(id)arg1 ChatToken:(id)arg2 NTPForCurrentFrame:(unsigned long long)arg3 NTPForBroadcasterFrame:(unsigned long long)arg4 LoggedInUser:(id)arg5 CompletionBlock:(CDUnknownBlockType)arg6;
+ (void)BeginCountdownForPublishingGuestCallerSession:(id)arg1 ChatToken:(id)arg2 LoggedInUser:(id)arg3 CompletionBlock:(CDUnknownBlockType)arg4;
+ (void)MuteOrUnMuteGuestBroadcastStreamForGuestCallerSession:(id)arg1 ChatToken:(id)arg2 LoggedInUser:(id)arg3 CompletionBlock:(CDUnknownBlockType)arg4;
+ (void)CancelGuestBroadcastStreamForGuestCallerSession:(id)arg1 ChatToken:(id)arg2 LoggedInUser:(id)arg3 GuestAnalyticsManager:(id)arg4 CompletionBlock:(CDUnknownBlockType)arg5;
...
+ (void)CancelCallInRequestForGuestCallerSession:(id)arg1 ChatToken:(id)arg2 LoggedInUser:(id)arg3 GuestAnalyticsManager:(id)arg4 CompletionBlock:(CDUnknownBlockType)arg5;
...
+ (void)GetGuestStateForIndividualSession:(id)arg1 LoggedInUser:(id)arg2 WorkClient:(id)arg3 CachePolicy:(long long)arg4;
