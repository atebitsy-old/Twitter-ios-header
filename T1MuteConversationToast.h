...
@interface T1MuteConversationToast : NSObject <T1ToastViewModel>
{
...
+ (id)unmuteConversationToastWithUndoAction:(CDUnknownBlockType)arg1;
+ (id)muteConversationToastWithUndoAction:(CDUnknownBlockType)arg1;
- (void).cxx_destruct;
...
- (id)initWithUndoAction:(CDUnknownBlockType)arg1;
- (id)init;
