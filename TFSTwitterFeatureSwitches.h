...
@class NSString, TFSObjectCache;

@interface TFSTwitterFeatureSwitches : NSObject <TFNTwitterFeatureSwitches>
{
    TFSObjectCache *_mainThreadValueCache;
    TFSObjectCache *_mainThreadIsInExperimentForKeyCache;
    TFSObjectCache *_mainThreadHasNonDefaultValueForKeyCache;
    NSString *_accountID;
}
