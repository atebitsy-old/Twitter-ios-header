...
@class NSAttributedString, NSString, TFNButtonActiveAnimation, TFNButtonAppearance, TFNButtonAppearanceImpl, TFNButtonAppearanceKey, UIColor, UIImage, UIImageView, UIImpactFeedbackGenerator, UILabel, UINotificationFeedbackGenerator, UISelectionFeedbackGenerator;
...
@property(retain, nonatomic) TFNButtonActiveAnimation *_tfn_activeAnimation;
