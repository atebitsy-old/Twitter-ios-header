...
- (void)_addParametersUsingDotSyntax:(id)arg1 combineRepeatingKeys:(_Bool)arg2 dictionaryKey:(id)arg3;
- (void)_addParametersUsingJSONEncoding:(id)arg1 combineRepeatingKeys:(_Bool)arg2 dictionaryKey:(id)arg3;
- (void)_addParametersUsingURLEncoding:(id)arg1 combineRepeatingKeys:(_Bool)arg2 dictionaryKey:(id)arg3;
- (void)_addParametersDirectly:(id)arg1 combineRepeatingKeys:(_Bool)arg2;
- (void)_updateWithDictionary:(id)arg1 combineRepeatingKeys:(_Bool)arg2 iterativeKeyBlock:(CDUnknownBlockType)arg3;
- (void)_setObject:(id)arg1 forKey:(id)arg2 combineRepeatingKeys:(_Bool)arg3;
