...
@interface T1UnifiedCardView : TFNLayoutableView <T1UnifiedCardComponentViewEventDelegate, TFNLayoutMetricsEnvironment, TFNPreviewable, T1AccessibilityCustomActionsProtocol>
{
    _Bool _hideBorder;
