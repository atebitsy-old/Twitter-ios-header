...
@class NSDate, TFSTwitterCameraColorPalette;

@interface TFSTwitterCameraMoment : NSObject <NSCopying, NSCoding, TFSEncodable>
{
    NSDate *_originalPostTime;
    TFSTwitterCameraColorPalette *_colorPalette;
}

+ (id)encodableName;
- (void).cxx_destruct;
@property(readonly, copy, nonatomic) TFSTwitterCameraColorPalette *colorPalette; // @synthesize colorPalette=_colorPalette;
